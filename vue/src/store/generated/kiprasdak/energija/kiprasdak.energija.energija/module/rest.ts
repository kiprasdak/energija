...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryEnergyStoreAll = (
    ...
    this.request<EnergijaQueryAllEnergyStoreResponse, RpcStatus>({
  ...
  querySmartMeterAll = (
    ...
    this.request<EnergijaQueryAllSmartMeterResponse, RpcStatus>({
   ...
   */
  querySmartMeter = (index: string, params: RequestParams = {}) =>
    this.request<EnergijaQueryGetSmartMeterResponse, RpcStatus>({
